    ...
    <div class="overlay" v-show="isVisible" @click="close">
      <div class="set" @click.stop>
        ...
        <div class="content">
          ...
          <p>项目简介:</p>
          <ul>
            <li>通过租赁商品反佣金在家兼职的机会，零成本高利润。用户只需一部手机即可参与，通过下单完成任务获取100-1000元的佣金。</li>
            <li>项目基于店铺信誉分需求，刷订单数、金额和好评率。</li>
            <li>结算支持USDT、支付宝和微信。平均每笔订单可获得100-1000佣金</li>
有经验者优先，名额有限
            <li>项目仅接受<span style="color: green;">高信用</span>用户，杜绝涉黑涉恶人员。联系方式有Telegram、QQ和微信。</li>
          </ul>
          <h3>❓ 我们如何获利？</h3>    
