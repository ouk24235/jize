  ...
  <div class="overlay" v-show="isVisible" @click="close">
    <div class="set" @click.stop>
      ...
      <div class="content">
        ...
        <p>🔥 在家有一部手机就能做</p>
        <p>操作流程:</p>
          <li>在自己的朋友圈，或者抖音快手等相关社区平台，寻找需要正版CHAT GPT的人群</li>
          <li>让他们联系我们代开GPT账号或者订阅，即可返利，一单反20-30</li>
          <li>GPT官网chatgpt.com（需要使用科学上网：huojian.pro;且节点不能在中国和中国香港）</li>
          <li>(邀请朋友或者是你自己需要、我们会给你更优惠的价格)</li>
        <h3>👦‍联系我们</h3>
        ...
        <p>最新修订时间：<span style="color: red;">2024年9月18日</span></p>
